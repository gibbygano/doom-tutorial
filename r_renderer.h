...
#ifdef _WIN64
#include "libs/win_sdl2/include/SDL.h"
#elif __APPLE__
#include "libs/macos_sdl2/include/SDL2/SDL.h"
#elif __linux__
#include "libs/linux_sdl2/include/SDL2/SDL.h"
#endif
...
sector_t R_CreateSector(int height, int elevation, unsigned int color, unsigned int ceil_clr, unsigned int floor_clor);
